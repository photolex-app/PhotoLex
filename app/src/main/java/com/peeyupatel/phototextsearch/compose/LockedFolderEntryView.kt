...
import com.peeyupatel.phototextsearch.helpers.AppDirectories
...
import com.peeyupatel.phototextsearch.helpers.copyImageListToPath
...
import com.peeyupatel.phototextsearch.mediastore.getMediaStoreDataFromUri
import com.peeyupatel.phototextsearch.mediastore.getUriFromAbsolutePath
...
fun LockedFolderEntryView(
    ...
    if (showExplanationForMigration.value) {
        ExplanationDialog(
            ...
            explanation = "Secure folder is now encrypted! All your Gallery are now fully safe and untouchable by anyone. \n\nAs a precaution, a copy of your secured Gallery is now present in an export folder, you can find it in the albums page or under \"Internal Storage/Android/media/com.peeyupatel.phototextsearch/PhotoLex/Exports\".",
