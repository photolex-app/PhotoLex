...
import com.peeyupatel.phototextsearch.compose.dialogs.FeatureNotAvailableDialog
        ...
        Column(
            ...
            if (showPrivacyPolicy.value) {
                ExplanationDialog(
                    ...
                    explanation = "There isn't one! None of your data goes anywhere but this device. No AI is trained on it, no algorithms to harvest information, nothing. PhotoLex has and always will be a privacy focused gallery app.",
        ...
        AlertDialog(
            ...
            text = {
                Column(
                    ...
                    Text(
                        text = "PhotoLex is built on Tulsi Gallery (github.com/AKS-Labs/Tulsi), which is itself a fork of LavenderPhotos. Both are open source under the GNU General Public License v3.0.",
                        fontSize = TextUnit(14f, TextUnitType.Sp),
                        textAlign = TextAlign.Center
                    )
                    ...
                    Row(
                        ...
                        Button(
                            ...
                            Text(
                                text = "Upstream Source (Tulsi Gallery)",
                                fontSize = TextUnit(14f, TextUnitType.Sp),
                            )
                        }
                    }
