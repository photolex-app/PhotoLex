...
import com.peeyupatel.phototextsearch.compose.dialogs.AnnotatedExplanationDialog
	...
	TopAppBar(
		...
		actions = {
			...
			val htmlString = remember {
				"""
					<p>Update checking is not yet available for PhotoLex.

						<br><br>PhotoLex never does auto-updates, and only ever updates with explicit user consent.
					</p>
				""".trimIndent()
			}
