...
/** PhotoLex doesn't have its own release feed yet (this was inherited from the Tulsi Gallery
 *  fork, which pointed at Tulsi's GitHub releases). Flip this to true once PhotoLex has its
 *  own public repo with releases to check against. */
