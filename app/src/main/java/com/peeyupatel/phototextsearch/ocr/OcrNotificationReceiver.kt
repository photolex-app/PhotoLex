...
class OcrNotificationReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        private const val ACTION_PAUSE = "com.peeyupatel.phototextsearch.OCR_PAUSE"
        private const val ACTION_RESUME = "com.peeyupatel.phototextsearch.OCR_RESUME"
        private const val ACTION_VIEW_PROGRESS = "com.peeyupatel.phototextsearch.OCR_VIEW_PROGRESS"
    }
    ...
    private fun openAppToSearchScreen(context: Context) {
        val intent = Intent(context, com.peeyupatel.phototextsearch.MainActivity::class.java).apply {
